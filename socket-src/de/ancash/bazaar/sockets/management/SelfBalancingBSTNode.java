...
public class SelfBalancingBSTNode{    
    ...
    private Map<UUID, Enquiry> enquiries = new CompactMap<UUID, Enquiry>();
    double height;
	...
	public Enquiry getByTimeStamp() {
		UUID temp = null;
		if(enquiries.isEmpty()) return null;
    ...
    public void remove(UUID id) {
    	getEnquiries().remove(id);
    }
    
    public boolean contains(UUID id) {
    	return getEnquiries().containsKey(id);
    }
    
    public Enquiry get(UUID id) {
    	return getEnquiries().get(id);
    }
    ...
    public Map<UUID, Enquiry> getEnquiries() {
    	return enquiries;
    }
    
	public SelfBalancingBSTNode getLeft() {
		return left;
	}
    
    public SelfBalancingBSTNode getRight() {
    	return right;
    }
