...
public class SelfBalancingBST {
 ...
 // This method mainly calls deleteRec()
   public void deleteKey(double key) { root = deleteRec(root, key); }
    ...
    private double minValue(SelfBalancingBSTNode root) {
 ...
 // Function to find k'th smallest element in BST
    ...
    private static double kthSmallest(SelfBalancingBSTNode root, AtomicInteger i, double k) {
        // base case
        if (root == null) {
            return Double.MAX_VALUE;
        }
 
        if(root.left == null && root.right == null) return root.getKey();
