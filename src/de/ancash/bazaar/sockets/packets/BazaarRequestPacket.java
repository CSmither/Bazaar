...
private static final long serialVersionUID = 5467314237006552099L;
	...
	public void setType(EnquiryType type) {
		if(type == EnquiryType.BUY_ORDER) this.type = 0;
		if(type == EnquiryType.SELL_OFFER) this.type = 1;
	}
	...
	public EnquiryType getType() {
		if(type == 0) return EnquiryType.BUY_ORDER;
		if(type == 1) return EnquiryType.SELL_OFFER;
		return null;
	}
